...
//  SideMenu
//
//  Created by Truong Son Nguyen on 10/6/17.
//  Copyright © 2017 Truong Son Nguyen. All rights reserved.
//

#import "AnimateControl.h"
#import <pop/pop.h>
@implementation AnimateControl
- (void) awakeFromNib {
    // Not usable with UIControls
    [super awakeFromNib];
    _contraint = 120.0/255.0;
...
- (void)setHighlighted:(BOOL)highlighted {
    ...
    if (self.highlighted) {
        ...
        [self pop_addAnimation:scaleAnimation forKey:@"scalingUpLabel"];
        ...
        [self pop_removeAllAnimations];
        [self pop_addAnimation:sprintAnimation forKey:@"springAnimationLabel"];
